...
#include "../../../../../Desktop/sunny-main/participant.h"
...
struct qt_meta_stringdata_CLASSParticipantENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSParticipantENDCLASS = QtMocHelpers::stringData(
    "Participant",
    "on_ajoutMat_clicked",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSParticipantENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Participant::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSParticipantENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSParticipantENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSParticipantENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Participant, std::true_type>,
...
void *Participant::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSParticipantENDCLASS.stringdata0))
