...
public:
    ...
    void setupUi(QWidget *Event)
    {
        ...
        groupBox->setGeometry(QRect(50, 40, 351, 271));
        ...
        remarque->setGeometry(QRect(140, 240, 113, 20));
