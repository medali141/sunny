...
template <> constexpr inline auto Employe::qt_create_metaobjectdata<qt_meta_tag_ZN7EmployeE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<Employe, qt_meta_tag_ZN7EmployeE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject Employe::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7EmployeE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7EmployeE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN7EmployeE_t>.metaTypes,
    nullptr
} };
...
void *Employe::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN7EmployeE_t>.strings))
